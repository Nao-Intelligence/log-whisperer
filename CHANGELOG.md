...
- Fix example Scripts updated ([#13](https://github.com/Nao-Intelligence/log-whisperer/pull/13))

## [0.2.9] - 2026-02-11

### Changed

- Chore include aws eb example doc ([#12](https://github.com/Nao-Intelligence/log-whisperer/pull/12))

## [0.2.8] - 2026-02-11

### Changed

- fix: capture stderr from docker and compose log commands ([#11](https://github.com/Nao-Intelligence/log-whisperer/pull/11))

## [0.2.7] - 2026-02-10

### Changed

- Chore change project name ([#10](https://github.com/Nao-Intelligence/log-whisperer/pull/10))
